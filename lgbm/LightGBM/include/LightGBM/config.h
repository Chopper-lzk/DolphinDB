...
struct Config {
  ...
  */
  ...
  static void KV2Map(std::map<std::string, std::string>* params, const char* kv);
  static std::map<std::string, std::string> Str2Map(const char* parameters);
  ...
  LIGHTGBM_EXPORT void Set(const std::map<std::string, std::string>& params);
 ...
 private:
  ...
  void GetMembersFromString(const std::map<std::string, std::string>& params);
...
struct ParameterAlias {
  static void KeyAliasTransform(std::map<std::string, std::string>* params) {
