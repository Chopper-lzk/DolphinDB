...
void Config::KV2Map(std::map<std::string, std::string>* params, const char* kv) {
...
std::map<std::string, std::string> Config::Str2Map(const char* parameters) {
...
void GetBoostingType(const std::map<std::string, std::string>& params, std::string* boosting) {
  std::string value;
...
void ParseMetrics(const std::string& value, std::vector<std::string>* out_metric) {
  std::set<std::string> metric_sets;
  out_metric->clear();
...
void GetObjectiveType(const std::map<std::string, std::string>& params, std::string* objective) {
  std::string value;
...
void GetMetricType(const std::map<std::string, std::string>& params, std::vector<std::string>* metric) {
  std::string value;
...
void GetTaskType(const std::map<std::string, std::string>& params, TaskType* task) {
  std::string value;
...
void GetDeviceType(const std::map<std::string, std::string>& params, std::string* device_type) {
  std::string value;
...
void GetTreeLearnerType(const std::map<std::string, std::string>& params, std::string* tree_learner) {
  std::string value;
...
void Config::Set(const std::map<std::string, std::string>& params) {
